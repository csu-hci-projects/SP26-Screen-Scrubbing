...
public class TimelineManager : MonoBehaviour {
    ...
    public float WorldXToTime(float worldX) {
        float t = Mathf.InverseLerp(timelineStartX, timelineEndX, worldX);
    ...
    public void PlaceClip(TimelineClip clip, float worldX) {
        ...
        float snappedX = Mathf.Lerp(timelineStartX, timelineEndX, snappedTime / totalDuration);
        
        clip.transform.position = new Vector3(snappedX, clip.transform.position.y, clip.transform.position.z); 
